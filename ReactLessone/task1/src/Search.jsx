...
class Search extends Component {
    ...
    render() {
        return <form className="login-form" onSubmit={this.props.onSumbit}>
            ...
            <div className="form-control">
                ...
                <input className="form-input" value={this.state.student}
                    onChange={this.handleChange} type="checkbox" id="student" name="student" />
            </div>
            <div className="form-control">
